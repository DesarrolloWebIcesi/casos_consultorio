...
<tr class="bugnote" id="c<?php echo $t_bugnote->id ?>">
        ...
        * 2010-04-22
        * Agregado para que los informadores no vean el nombre del usuario que puso la nota
        */
        ...
        <?php
            ...
            */
            ...
            echo str_replace($mes_ingles, $mes_espanol, date( $t_normal_date_format, $t_bugnote->date_submitted ));
        ?>
        </span><br />
		<?php
