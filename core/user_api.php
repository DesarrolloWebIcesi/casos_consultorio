...
// Se agregó para que no almacene el password en la BD si la autenticación es LDAP
  if (config_get( 'login_method' ) != LDAP)
  {
...
// rjaramillo 2011-03-02
// Se agregó para que no actualice el password en la BD si la autenticación es LDAP
  		if ( config_get( 'login_method' ) == LDAP && $c_field_name == 'password' )
  			{
  			$p_field_value = '';
  			}
