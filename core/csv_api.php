...
function csv_format_date_submitted( $p_bug ) {
    ...
    */
	...
	return str_replace($mes_ingles, $mes_espanol, date( $s_date_format, $p_bug->date_submitted ));
}
...
function csv_format_last_updated( $p_bug ) {
    ...
    */
	...
	if ( $s_date_format === null )
		$s_date_format = config_get( 'short_date_format' );
	return str_replace($mes_ingles, $mes_espanol, date( $s_date_format, $p_bug->last_updated ));
}
