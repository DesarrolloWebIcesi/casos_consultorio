...
// Agregado para soportar campos TEXTAREA personalizados
...
// Agregado para soportar campos TEXTAREA personalizados
  $t_value_field = ( $row['type'] == CUSTOM_FIELD_TYPE_TEXTAREA ? 'text' : 'value' );
	...
	$t_custom_field_string_table = db_get_table( 'mantis_custom_field_string_table' );
// rjaramillo 2011-07-18
// Modificado para soportar campos TEXTAREA personalizados
//  $query = "SELECT value
...
function print_custom_field_input( $p_field_def, $p_bug_id = null ) {
    ...
    // Le agregué a la condición $p_field_def['type'] == CUSTOM_FIELD_TYPE_STRING ||
		if( $t_custom_field_value === null &&
			( $p_field_def['type'] == CUSTOM_FIELD_TYPE_ENUM ||
                $p_field_def['type'] == CUSTOM_FIELD_TYPE_STRING ||
