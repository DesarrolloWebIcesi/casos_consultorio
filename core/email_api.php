...
//		$t_message .= $t_email_separator1 . " \n";
  ...
  // rjaramillo 2011-06-02
  // Se agrega mensaje personalizado para los casos en estado RESUELTO
  if($p_visible_bug_data['email_status'] == "resuelto")
  {
    $t_message .= "\nPor tal motivo ingrese al Sistema de Gestión de Solicitudes, para revisar y confirmar su caso, a través del botón ";
    $t_message .= "<Cambiar estado a: confirmado> o respondiendo a este correo electrónico.\n";
  }
  $t_message .= " \n" . $t_email_separator1 . " \n";
